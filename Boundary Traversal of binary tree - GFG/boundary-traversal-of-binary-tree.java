...
class Solution
{
    void leftTraversal(Node root, ArrayList <Integer> list){
        ...
        else if (root.right != null)leftTraversal(root.right, list);
    ...
    void rightTraversal(Node root, ArrayList <Integer> list){
        ...
        else if (root.left != null)rightTraversal(root.left, list);
        list.add(root.data);
        
    }
    void leafTraversal(Node root, ArrayList <Integer> list){
        if(root == null)return;
	...
	ArrayList <Integer> boundary(Node node)
	{
	    ...
	    if(node == null)return traversals;
	    
	    traversals.add(node.data);
	    
	   // traversaing the left part of tree
	    leftTraversal(node.left, traversals);
	   //System.out.println(traversals);
	   // traversing leaf nodes of tree
	    leafTraversal(node.left, traversals);
	   //System.out.println(traversals);
	    leafTraversal(node.right, traversals);
	   //System.out.println(traversals);
	   
	   rightTraversal(node.right, traversals);
	   //System.out.println(traversals);
